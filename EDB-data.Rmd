...
description: |
  The *WTO Environemntal Database* (EDB) collects all environment-related policies that have been notified to the WTO. Here, you may find an extension to the EDB specifically developed for economic research and policy analysis.
