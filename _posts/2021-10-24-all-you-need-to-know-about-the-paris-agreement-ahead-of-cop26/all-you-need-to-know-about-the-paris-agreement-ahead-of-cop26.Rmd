...
Alas, it's too early to celebrate. We already had two big agreements on climate change: the 1992 UN Framework Convention on Climate Change (UNFCCC), which established the institutions and principles for cooperation on climate change, and the 1997 Kyoto Protocol, which imposed binding emission reduction targets for a handful of developed nations. Yet, judging from the current and projected GHG emission trends in the figure below, they were not terribly effective at stopping climate change. If they had, we would not be writing about a third agreement on the same issue. 

```{r, fig.cap="GHG concentration and global warming <br>Source: IPCC 2019 special report on Global warming of 1.5°C"}
knitr::include_graphics("figure-2.3.jpg")
```
