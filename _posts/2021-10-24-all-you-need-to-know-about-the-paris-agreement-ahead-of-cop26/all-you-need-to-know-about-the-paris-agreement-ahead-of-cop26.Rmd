...
2. A flexible target setting for participants, in which each country is free to establish its objectives and the way it proposes to achieve them. The self-determined goals are called Nationally Determined Contribution (NDC). 
