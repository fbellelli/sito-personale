...
- [This article](https://plus.maths.org/content/uncovering-cause-cholera) tells the story of how Voronoi diagrams were used by John Snow to show the link between water pumps and the transmission of Cholera. 


- [Amil Patel](https://simblob.blogspot.com/search/label/voronoi) has a phenomenal blog on game development. Hi highly recommend his posts on procedural map generation with Voronoi diagrams.
